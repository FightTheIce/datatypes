...
class Application
{
    public function __construct(bool $aliasClasses = false, string $ns = '')
    {
        if ($aliasClasses == true) {
            ...
            $classes = [
                \FightTheIce\Datatypes\Compounds\Array_::class => [
                    $ns . 'Arr_',
                    $ns . 'Array_'
                ],
                \FightTheIce\Datatypes\Compounds\Object_::class => [
                    $ns . 'Obj_',
                    $ns . 'Object_'
                ],
                \FightTheIce\Datatypes\Scalar\Boolean_::class => [
                    $ns . 'Bool_',
                    $ns . 'Boolean_'
                ],
                \FightTheIce\Datatypes\Scalar\Float_::class => [
                    $ns . 'Float_',
                    $ns . 'Flt_',
                    $ns . 'Double_',
                    $ns . 'Dbl_'
                ],
                \FightTheIce\Datatypes\Scalar\Integer_::class => [
                    $ns . 'Int_',
                    $ns . 'Integer_'
                ],
                \FightTheIce\Datatypes\Scalar\String_::class => [
                    $ns . 'Str_',
                    $ns . 'String_'
                ],
                \FightTheIce\Datatypes\Scalar\UnicodeString_::class => [
                    $ns . 'UniStr_',
                    $ns . 'UnicodeStr_',
                    $ns . 'UnicodeString_',
                    $ns . 'UniString_'
                ],
                \FightTheIce\Datatypes\Special\Null_::class => [
                    $ns . 'Null_'
                ],
                \FightTheIce\Datatypes\Pseudo\Mixed_::class => [
                    $ns . 'Mixed_'
                ],
                \FightTheIce\Datatypes\Pseudo\Number_::class => [
                    $ns . 'Number_',
                    $ns . 'Num_'
                ],
